...
#include "spec.h"
  ...
  if (dwg->header.num_header_vars > 83) {
  FIELD_CAST (DIMZIN, RC, B, 70); //ok
  FIELD_RD (DIMRND, 40);
  FIELD_RD (DIMDLE, 40);
  FIELD_TFv (DIMBLK_T, 32, 1);
  FIELD_RC (circle_zoom_percent, 0);
  FIELD_RC (COORDS, 0);
